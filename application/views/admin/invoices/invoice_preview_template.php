         ...
         <div class="row">
            ...
            <div class="col-md-9 _buttons">
               ...
               <div class="pull-right">
                  ...
                  <a href="<?php echo admin_url('invoices/invoice/'.$invoice->id . '/' .  $invoice->hash); ?>" data-toggle="tooltip" title="<?php echo _l('edit_invoice_tooltip'); ?>" class="btn btn-default btn-with-tooltip" data-placement="bottom"><i class="fa fa-pencil-square-o"></i></a>
                  <?php } ?>
                  <div class="btn-group">
			...
			<?php if(has_permission('payments','','create') && abs($invoice->total) > 0){ ?>
                         <a href="<?php echo admin_url('boletos/boleto/'.$invoice->id); ?>" target="_blank" return false;"  class="btn-with-tooltip btn btn-default <?php if($invoice->status == 2 || $invoice->status == 5){echo ' disabled';} ?>" data-toggle="tooltip" data-title="<?php echo _l('Gerar Boleto'); ?>"data-placement="bottom"><span data-toggle="tooltip" data-title="<?php echo $_tooltip_already_send; ?>"><i class="fa fa-barcode"></i></span></a>
    			<?php } ?>
            	  <?php } ?>
		<!-- Single button -->
                  <div class="btn-group">
