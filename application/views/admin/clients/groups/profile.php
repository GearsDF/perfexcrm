   ...
   <div class="col-md-12">
      ...
      <div class="tab-content">
         ...
         <div role="tabpanel" class="tab-pane<?php if(!$this->input->get('tab')){echo ' active';}; ?>" id="contact_info">
		  ...
		  <?php $value=(isset($client) ? $client->inscricao_estadual : ''); ?>
                  <?php echo render_input( 'inscricao_estadual', 'Inscricao Estadual',$value); ?>
		  ...
		  <?php $value=( isset($client) ? $client->phonenumber : ''); ?>
               ...
               <div class="col-md-6">
		  <?php $value=(isset($client) ? $client->fantasia : ''); ?>
		  <?php echo render_input( 'fantasia', 'Nome Fantasia',$value); ?>
                  <?php $value=( isset($client) ? $client->address : ''); ?>
                  <?php echo render_textarea( 'address', 'client_address',$value); ?>
                  <?php $value=(isset($client) ? $client->bairro : ''); ?>
                  <?php echo render_input( 'bairro', 'Bairro',$value); ?>
         ...
         <div role="tabpanel" class="tab-pane" id="billing_and_shipping">
			...
			<?php $value=(isset($client) ? $client->billing_bairro : ''); ?>
			<?php echo render_input( 'billing_bairro', 'Bairro',$value); ?>       
			...
			<?php $value=(isset($client) ? $client->shipping_bairro : ''); ?>
                  	<?php echo render_input( 'shipping_bairro', 'Bairro',$value); ?>
